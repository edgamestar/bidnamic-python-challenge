# Generated by Django 3.1.7 on 2022-03-20 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=10)),
                ('campaign', models.ForeignKey(db_column='campaign', on_delete=django.db.models.deletion.PROTECT, to='portal.campaign')),
            ],
            options={
                'db_table': 'ad_group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_group', models.ForeignKey(db_column='ad_group', on_delete=django.db.models.deletion.PROTECT, to='portal.adgroup')),
                ('campaign', models.ForeignKey(db_column='campaign', on_delete=django.db.models.deletion.PROTECT, to='portal.campaign')),
            ],
            options={
